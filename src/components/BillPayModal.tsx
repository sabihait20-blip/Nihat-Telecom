...
import {
  ...
  AlertTriangle, Eye, HelpCircle, Check, Search, ChevronRight
} from 'lucide-react';
              ...
              <div className="space-y-2 text-center">
                ...
                {pinError && (
                  <p className="text-center text-rose-500 text-[10px] font-bold">
                    {lang === 'bn' ? 'ভুল পিন দিয়েছেন! সঠিক পিন: ১২৩৪' : 'Incorrect PIN! Try: 1234'}
                  </p>
                )}
                <p className="text-[10px] text-amber-600 font-bold bg-amber-500/10 px-3 py-1 rounded-full w-fit mx-auto">
                  {t.demoPinWarning}
                </p>
              </div>
